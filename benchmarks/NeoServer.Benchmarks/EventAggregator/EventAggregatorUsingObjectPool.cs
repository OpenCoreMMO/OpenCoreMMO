...
public class EventAggregatorUsingObjectPool
{
    private static Game.Common.Aggregator.EventAggregator _instance = null;
    public static Game.Common.Aggregator.EventAggregator Instance => _instance ??= new Game.Common.Aggregator.EventAggregator();
