...
public delegate void BuyItem(INpc npc, IPlayer player, IItemType itemType, int count, uint totalCost, bool inBackpack, bool ignore = false);
public delegate void SellItem(INpc npc, IPlayer player, IItemType itemType, int count, uint totalCost, bool ignore = false);
