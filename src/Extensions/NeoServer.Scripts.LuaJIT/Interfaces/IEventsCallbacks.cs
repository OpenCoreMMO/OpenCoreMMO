...
public interface IEventsCallbacks
{
    ...
    /// <summary>
    /// Checks all callbacks registered for the specified event type and returns the first value different from noErrorValue.
    /// </summary>
    ...
    TReturn CheckCallbackWithReturnValue<TReturn>(EventCallbackType eventType, Func<EventCallback, TReturn> callbackFunc, TReturn noErrorValue)
