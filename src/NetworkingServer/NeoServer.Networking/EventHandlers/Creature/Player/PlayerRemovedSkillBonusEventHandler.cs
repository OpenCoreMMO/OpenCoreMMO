...
public class PlayerRemovedSkillBonusEventHandler(IGameServer game) : INetworkingEventHandler<PlayerRemovedSkillBonusEvent>
{
    public void Handle(PlayerRemovedSkillBonusEvent @event)
    {
