...
public class CreatureStoppedWalkingEventHandler(IGameServer game)
    : INetworkingEventHandler<CreatureStoppedWalkingEvent>
{
    public void Handle(CreatureStoppedWalkingEvent @event)
    {
