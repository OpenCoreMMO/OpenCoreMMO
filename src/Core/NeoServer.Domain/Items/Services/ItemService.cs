...
public class ItemService : IItemService
{
    ...
    public IItem Transform(ITile tile, ushort fromItemId, ushort toItemId)
    {
        ...
        var newItem = _itemFactory.Create(toItemId, tile.Location, new Dictionary<ItemAttribute, IConvertible>(), null);
    ...
    public IItem Create(Location location, ushort id)
    {
        ...
        var newItem = _itemFactory.Create(id, tile.Location, new Dictionary<ItemAttribute, IConvertible>(), null);
