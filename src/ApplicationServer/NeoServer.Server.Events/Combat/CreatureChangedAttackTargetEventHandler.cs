...
public class CreatureChangedAttackTargetEventHandler(
    ...
    : IApplicationEventHandler<CreatureChangedAttackTargetEvent>
{
    public void Handle(CreatureChangedAttackTargetEvent @event)
    {
    ...
    private bool Attack(ICombatActor actor)
    {
        ...
        actor.AttackEvent = 0;
        Handle(new CreatureChangedAttackTargetEvent(actor,0 ,0 ));
