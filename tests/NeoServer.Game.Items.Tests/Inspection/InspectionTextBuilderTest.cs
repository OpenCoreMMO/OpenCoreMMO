...
public class InspectionTextBuilderTest
{
    ...
    [InlineData("You see  item.\nIt can only be wielded properly by knights, paladins and sorcerers.", "knight",
        "paladin", "sorcerer")]
    [InlineData("You see  item.\nIt can only be wielded properly by knights, paladins, sorcerers and druids.", "knight",
