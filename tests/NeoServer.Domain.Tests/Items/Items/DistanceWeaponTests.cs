...
public class DistanceWeaponTests
{
    ...
    {
        var sut = ItemTestData.CreateDistanceWeapon(1, itemTypeAttributes: Array.Empty<(ItemTypeAttribute, IConvertible)>());
    ...
    {
        var sut = ItemTestData.CreateDistanceWeapon(1, itemTypeAttributes: new (ItemTypeAttribute, IConvertible)[]
        {
        ...
        int requiredVocation)
    {
        ...
        var sut = (IDistanceWeapon)ItemTestData.CreateDistanceWeapon(1, itemTypeAttributes: new (ItemTypeAttribute, IConvertible)[]
        {
