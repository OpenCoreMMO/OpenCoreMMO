...
public class DecayableTests : IAsyncLifetime
{
    ...
    public void Expired_DidNotStartToDecay_ReturnsFalse()
    {
        ...
        var item = ItemTestData.CreateDefenseEquipmentItem(2, itemTypeAttributes: Array.Empty<(ItemTypeAttribute, IConvertible)>());

        var decayableItem = ItemTestData.CreateDefenseEquipmentItem(1, itemTypeAttributes: new (ItemTypeAttribute, IConvertible)[]
        {
    ...
    public async Task Item_that_has_decay_behavior_decays_after_expiration()
    {
        ...
        var item1 = (IEquipment)ItemTestData.CreateWeaponItem(1, itemTypeAttributes: new (ItemTypeAttribute, IConvertible)[]
        {
            (ItemTypeAttribute.Duration, 1)
        });

        var item2 = (IEquipment)ItemTestData.CreateWeaponItem(2, itemTypeAttributes: new (ItemTypeAttribute, IConvertible)[]
        {
