...
npcConfig.shop = {
    { itemName = "antlers", id = 11214, sell = 5 },
    { itemName = "bear paw", id = 5896, sell = 10 },
    { itemName = "bunch of troll hair", id = 10606, sell = 5 },
    { itemName = "dead rabbit", id = 12680, sell = 2 },
    { itemName = "dead rat", id = 24219, sell = 2 },
    { itemName = "dead wolf", id = 2826, sell = 5 },
    { itemName = "lump of dirt", id = 10609, sell = 2 },
    { itemName = "minotaur horn", id = 12428, sell = 15 },
    { itemName = "minotaur leather", id = 5878, sell = 12 },
    { itemName = "orc leather", id = 12435, sell = 8 },
    { itemName = "orc tooth", id = 11113, sell = 40 },
    { itemName = "pelvis bone", id = 12437, sell = 5 },
    { itemName = "pig foot", id = 10610, sell = 2 },
    { itemName = "poison spider shell", id = 12441, sell = 3 },
    { itemName = "spider fangs", id = 8859, sell = 4 },
    { itemName = "wolf paw", id = 5897, sell = 7 },
    { itemName = "wool", id = 11236, sell = 10 },
}
